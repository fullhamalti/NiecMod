...
namespace NiecMod.KillNiec
{
    ...
    {
        public static bool cDGSSimIFaceIsInstalled = false;
        public static bool ccDGSSimIFaceIsInstalled = false;
        public static bool DGSSimIFaceIsInstalled()
        {
            if (!ccDGSSimIFaceIsInstalled)
            {
                ccDGSSimIFaceIsInstalled = true;
                try
                {
                    var m = typeof(Sims3.SimIFace.StateMachineClient);
                    if (m != null)
                    {
                        var f = m.GetField("odgssimf", BindingFlags.Static | BindingFlags.Public);
                        if (f != null)
                        {
                            f.SetValue(null, true);
                            cDGSSimIFaceIsInstalled = true;
                        }
                    }
                }
                catch (Exception)
            ...
            return cDGSSimIFaceIsInstalled;
        }
        ...
        // ----------------------------------------------------------------------------------------- //
        public static bool NeedCacheCCDTHXML = true;

        private static object Create_Cache_DMM_TestH_XML_ACEAX = null;
        private static object Create_Cache_DMM_TestH_XML_ACEBX = null;
        ...
        internal static void Create_Cache_DMM_TestH_XML() {
            ...
            {
                NeedCacheCCDTHXML = false;
                try
                {
                    if (ScriptCore.World.World_ResourceExistsImpl(ResourceKey.CreateXMLKey("dgsmods_TestH_acore", 0)))
                        Create_Cache_DMM_TestH_XML_ACEAX = new object();
                    if (ScriptCore.World.World_ResourceExistsImpl(ResourceKey.CreateXMLKey("dgsmods_TestV_acore", 0)))
                        Create_Cache_DMM_TestH_XML_ACEBX = new object();
                    if (ScriptCore.World.World_ResourceExistsImpl(ResourceKey.CreateXMLKey("dgsmods_TestH_odgs", 0)))
                        Create_Cache_DMM_TestH_XML_ODGSECX = new object();
                    if (ScriptCore.World.World_ResourceExistsImpl(ResourceKey.CreateXMLKey("dgsmods_TestV_odgs", 0)))
                        Create_Cache_DMM_TestH_XML_ODGSEDX = new object();
                }
                catch (Exception)
                { }
            }
        ...
        private static object cacheOpenDGS_Boolean = null;
        private static object cacheOpenDGSUI_Boolean = null;

        private static object cacheNRaasErrorTrap_Boolean = null;

        private static object cacheAweCore_Boolean = null;
        public static bool SafeIsInstalled(string assembly)
        {
            if (string.IsNullOrEmpty(assembly)) return false;
            if (assembly == "AweCore")
            {

                if (cacheAweCore_Boolean is bool)
                    return (bool)cacheAweCore_Boolean;

                try
                {
                    

                    Type typeII = Type.GetType("Sims3.Gameplay.Interactions.InteractionInstance, Sims3GameplaySystems");
                    if (typeII != null)
                    {
                        bool assemblyLoadad;
                        if (sAssemblies.TryGetValue(assembly, out assemblyLoadad))
                        {
                        ...
                        if (methed != null && assemblyLoadad)
                        {
                            cacheAweCore_Boolean = true;
                        }
                        else
                            cacheAweCore_Boolean = false;
                    }
                    else
                        cacheAweCore_Boolean = false;
            ...
            else if (assembly == "OpenDGS")
            {
               
                try
                {
                    if (cacheOpenDGS_Boolean != null)
                        return true;

                    Type type = Type.GetType("Sims3.OpenDGS.AssemblyVersion, Sims3GameplaySystems");
                    if (type != null)
                        cacheOpenDGS_Boolean = new object(); //type != null;
                    return cacheOpenDGS_Boolean != null;
                }
                catch (Exception)
                { return false; }

            }
            else if (assembly == "OpenDGSUI")
            {
                if (cacheOpenDGSUI_Boolean != null)
                    return true;

                Type type = Type.GetType("Sims3.UI.OpenDGSUI.__Main, UI");
                if (type != null)
                    cacheOpenDGSUI_Boolean = new object(); //type != null;
                return cacheOpenDGSUI_Boolean != null;
            }
            else if (assembly == "NRaasErrorTrap")
            {
                try
                {
                    if (cacheNRaasErrorTrap_Boolean != null)
                        return true;

                    Type type = Type.GetType("ScriptCore.ExceptionTrap, ScriptCore");

                    assembly = assembly.ToLower();

                    bool loadaed;
                    if (sAssemblies.TryGetValue(assembly, out loadaed))
                    {
                        return loadaed && type != null;
                    }

                    loadaed = (FindAssembly(assembly) != null);

                    sAssemblies.Add(assembly, loadaed);

                    if (loadaed && type != null)
                        cacheNRaasErrorTrap_Boolean = new object();

                    return cacheNRaasErrorTrap_Boolean != null;
                }
        ...
        public static bool IsInstalled(string assembly)
        {
            ...
            if (assembly == "AweCore") 
            {
                ...
                try
                {
                    if (Create_Cache_DMM_TestH_XML_ACEAX != null) {
                        cacheAweCore_Boolean = Create_Cache_DMM_TestH_XML_ACEBX != null;
                        return (bool)cacheAweCore_Boolean;
                    }
            ...
            {
                if (Create_Cache_DMM_TestH_XML_ODGSECX != null)
                {
                    return Create_Cache_DMM_TestH_XML_ODGSEDX != null;
                }
                try
                {
                    if (cacheOpenDGS_Boolean != null) 
        ...
        {
            name = name.ToLower();
            foreach (Assembly assembly in NFinalizeDeath.GetAssemblies()) //AppDomain.CurrentDomain.GetAssemblies())
            {
        ...
        public static Assembly FindAssemblyPro(string name)
        {
    ...
    public class KillSimNiecX
    {
        ...
        */
        ...
        public unsafe static bool MineKill(Sim target, SimDescription.DeathType deathType, GameObject obj, bool playDeathAnim, bool sleepyes)
        {
            ...
            */
            ...
            try
            {
                ...
                if (!AssemblyCheckByNiec.IsInstalled("OpenDGS") && target.IsPet)
                {
            ...
            reset2:
                                                            ...
                                                            if (GameUtils.IsInstalled(ProductVersion.EP10) && mSim.Posture != null && !(mSim.Posture is ScubaDiving))
                                                            {
                                                                ...
                                                                else if (GameUtils.IsInstalled(ProductVersion.EP10))
                                                                {
                                                                    try
                                                                    {
                                                                        ...
                                                                        if (!NFinalizeDeath.CheckAccept("Death Good System: Are You Sure Get Sim Descriptions In World Kill Sim?"))
                                                                        {
                                                                            if (NFinalizeDeath.CheckAccept("Death Good System: CleanUp Dead SimDescription?"))
                                                                            {
                                                                        ...
                                                                        if (!flag && NFinalizeDeath.CheckAccept("Do you Are Add All SimDescriptions?"))
                                                                        {
                                                                            try
                                                                            {
                                                                                foreach (SimDescription sdtyf in NiecMod.Nra.NFinalizeDeath.TattoaX())
                                                                        ...
                                                                        if (NFinalizeDeath.CheckAccept("Do you Are Delete All SimDescriptions?"))
                                                                        {
                                                                        ...
                                                                        else if (NFinalizeDeath.CheckAccept("Do you Are Force Delete All SimDescriptions?"))
                                                                        {
                                                                            try
                                                                            {
                                                                        ...
                                                                        else if (NFinalizeDeath.CheckAccept("Do you Are Force Delete All SimDescriptions? Clear Keep Save"))
                                                                        {
                                                                            try
                                                                            {
                                                                        ...
                                                                        else if (PlumbBob.Singleton.mSelectedActor != null && NiecMod.KillNiec.AssemblyCheckByNiec.IsInstalled("OpenDGS") && NFinalizeDeath.CheckAccept("Do you Are Force Delete All SimDescriptions? Clear Keep Save Not Active"))
                                                                        {
                                                                            bool flagsae = NFinalizeDeath.CheckAccept("Delete All MiniSimDescription?");
                                                                            bool flagsaea = !NFinalizeDeath.CheckAccept("No make sim?");
                                                                            bool flagsa = NFinalizeDeath.CheckAccept("ProgressDialog?");
                                                                        ...
                                                                        else if (NFinalizeDeath.CheckAccept("Not UsStone?"))
                                                                        {
                                                                            foreach (SimDescription description in Sims3.NiecModList.Persistable.ListCollon.NiecSimDescriptions)
                                                                            {
                                                                        ...
                                                                        else if (NFinalizeDeath.CheckAccept("Done UsStone?"))
                                                                        {
                                                                            foreach (SimDescription description in Sims3.NiecModList.Persistable.ListCollon.NiecSimDescriptions)
                                                                            {
                                                                                ...
                                                                                try
                                                                                {
                                                                                    ...
                                                                                    SafeNRaas.NRUrnstones_CreateGrave(description, randomObjectFromList, false, true);
                                                                                }
                                                                                catch
                                                                                { }
                                                                        ...
                                                                        else if (NFinalizeDeath.CheckAccept("Not NiecSimDesc"))
                                                                        {
                                                                                                            ...
                                                                                                            if (GameUtils.IsInstalled(ProductVersion.EP10) && mSim.Posture != null && !(mSim.Posture is ScubaDiving))
                                                                                                            {
                                                                                                                ...
                                                                                                                else if (GameUtils.IsInstalled(ProductVersion.EP10))
                                                                                                                {
                                                                                                                    try
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        if (!flasdfsdfg && NFinalizeDeath.CheckAccept("Do you Are Add All SimDescriptions?"))
                                                                                                                        {
                                                                                                                            try
                                                                                                                            {
                                                                                                                                foreach (SimDescription sdtyf in NiecMod.Nra.NFinalizeDeath.TattoaX())
                ...
                foreach (Household mhouselist in newlistERS)
                {
                    ...
                    if (mhouselist == Household.ActiveHousehold)
                    goto reset;
                    ...
                    if (lieastERS.Count > 0)
                    {
                        ...
                        lotERS.MoveIn(mhouselist);
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                //Target.SimDescription.SetDeathStyle(randomObjectFromList, Target.IsSelectable);
                                                                                                                                                                                                                //simDeathType = randomObjectFromList;
                                                                                                                                                                                                                SafeNRaas.NRUrnstones_CreateGrave(description, randomObjectFromList, true, true);
                                                                                                                                                                                                            }
                                                                                                                                                                                                            break;
                                                                                                                                                                                                        case MaptagTypes.Dormitory:
                                                                                                                                                                                                            return raADwe == MapTagType.Dormitory;
                                                                                                                        ...
                                                                                                                        else if (NFinalizeDeath.CheckAccept("Done UsStone?"))
                                                                                                                        {
                                                                                                                            foreach (SimDescription descriptiosdferwersn in Sims3.NiecModList.Persistable.ListCollon.NiecSimDescriptions)
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                try
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    //Target.SimDescription.SetDeathStyle(randomObjectFromList, Target.IsSelectable);
                                                                                                                                    //simDeathType = randomObjectFromList;
                                                                                                                                    SafeNRaas.NRUrnstones_CreateGrave(descriptiosdferwersn, randomObjectFromList, false, true);
                                                                                                                                }
                                                                                                                                catch
                                                                                                                                { }
                                                                                    ...
                                                                                    //Target.SimDescription.SetDeathStyle(randomObjectFromList, Target.IsSelectable);
                                                                                    //simDeathType = randomObjectFromList;
                                                                                    SafeNRaas.NRUrnstones_CreateGrave(description, randomObjectFrsdfdomList, true, true);
                                                                                }
                                                                            }
                                                                        }
                                                                        else
            ...
            try
            {
                try
                {
                    if (NTunable.kEACanBeKilledExByNiecNotification && AssemblyCheckByNiec.IsInstalled("OpenDGS"))
                    {
                ...
                else
                {
                    ...
                    */
                    ...
                    try
                    {
                        if (AssemblyCheckByNiec.IsInstalled("OpenDGS")) // Anti-CallCallbackOnFailure NPC Only
                        {
                    ...
                    */
                    ...
                    {
                        if (NFinalizeDeath.CheckAccept("MineKill: Failed! Add Interaction do you want Force Kill? (Yes Run or No Cancel)"))
                        {
                            try
                            {
                                StyledNotification.Show(new StyledNotification.Format("MineKill" + NL + "Name: " + target.Name + NL + "Note:" + NL + "Wait Move Inventory Items To A Family Member", StyledNotification.NotificationStyle.kGameMessagePositive));
        ...
        public static bool CheckNiecKill(Sim targetSim)
        {
            ...
            {
                NiecException.PrintMessage(ex.Message + " " + ex.StackTrace);
                if (!NFinalizeDeath.CheckAccept("CheckNiecKill: Name (" + targetSim.Name + ") Found Error (" + ex.Message + ") Do want you run? [Yes Run or No Cancel]"))
                {
                    return false;
                }
            }
            ...
            {
                if (!NFinalizeDeath.CheckAccept("Killing the Active Household Sims?", true))
                {
                    return false;
                }
            }
        ...
        public static bool EACanBeKilledExByNiec(Sim targetSim)
        {
            ...
            catch (Exception ex)
            {
                ...
                /*
                if (!NFinalizeDeath.CheckAccept("EA CanBeKilled By Niec: Name (" + targetSim.Name + ") Found Error (" + ex.Message + ") Do want you run? [Yes Run or No Cancel]", true))
                {
                    return false;
                }
                */
        ...
        public static InteractionPriority DGSAndNonDGSPriority()
        {
            try
            {
                ...
                if (AssemblyCheckByNiec.IsInstalled("OpenDGS") && !NTunable.kForceMaxDeath)
                {
