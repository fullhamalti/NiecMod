...
namespace NiecMod.Nra
{
    ...
    public class niec_native_func
    {
      ...
      /*{
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        public static extern bool niecmod_native_file_create(string path);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        public static extern bool niecmod_native_file_while(string path, IntPtr data);

        [MethodImpl(MethodImplOptions.InternalCall)]
        public static extern bool niecmod_native_file_whiletext(string path, string text);
