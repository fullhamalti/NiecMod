...
namespace Sims3.Gameplay.Objects.Niec
{
    ...
    {
        /*
        public override ScriptExecuteType GetScriptExecuteType()
        {
        ...
        private sealed class Sim_Auto_Niec : Interaction<Sim, NiecObject>
        {
            ...
            public AlarmHandle AI = AlarmHandle.kInvalidHandle;
            // Methods
...
*/
            ...
            public override InteractionTestResult Test(ref InteractionInstanceParameters parameters, ref GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                try
                {
                    if (!Test(parameters.Actor as Sim, parameters.Target as NiecObject, parameters.Autonomous, ref greyedOutTooltipCallback))
                    {
                ...
                {
                    if (isAutonomous && target.DisAlry) return false;
