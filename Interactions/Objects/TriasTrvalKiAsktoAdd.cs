...
namespace NiecMod.Interactions.Objects
{
    public sealed class TriasTrvalKiAsktoAdd : ImmediateInteraction<Sim, TriasTrvalKi>
    {
        ...
        private sealed class Definition : ImmediateInteractionDefinition<Sim, TriasTrvalKi, TriasTrvalKiAsktoAdd>, IInteractionDefinitionIsValidForStrangerTarget, IAllowedOnClosedVenues, IOverridesAgeTests, IUseTargetForAutonomousIsAllowedInRoomCheck, IScubaDivingInteractionDefinition, IUsableWhileOnFire, IUsableDuringFire, IUsableDuringBirthSequence, IUsableDuringShow
        {
